...
- [ ] Add method for detecting user's device: desktop or mobile to display different screens in itch.io's game iframe. Just like the GB Studio HTML export.
- [ ] Experiment with an right side progress or "health" bar which should fill from bottom to top. 
- [ ] Use that progress bar meter for something. Maybe coffee fuel?
